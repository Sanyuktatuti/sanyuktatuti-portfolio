      ...
      <div className="relative">
        ...
        <div className="relative z-10">
          <section id="about" className="relative min-h-screen">
            ...
            <SectionRevealWrapper className="relative z-10 container mx-auto" delay={0.1}>
              <About />
          ...
          <section id="education" className="relative min-h-screen">
            <div className="absolute inset-0 bg-[#030014]/50 backdrop-blur-[8px]" />
            <SectionRevealWrapper className="relative z-10 container mx-auto" delay={0.2}>
              <Education />
            </SectionRevealWrapper>
          </section>
          ...
          <section id="experience" className="relative min-h-screen">
            <div className="absolute inset-0 bg-[#030014]/50 backdrop-blur-[8px]" />
            <SectionRevealWrapper className="relative z-10 container mx-auto" delay={0.3}>
              <Experience />
            </SectionRevealWrapper>
          </section>
          ...
          <section id="skills" className="relative min-h-screen">
            <div className="absolute inset-0 bg-[#030014]/50 backdrop-blur-[8px]" />
            <SectionRevealWrapper className="relative z-10 container mx-auto" delay={0.4}>
              <EnhancedSkills />
            </SectionRevealWrapper>
          </section>
          ...
          <section id="projects" className="relative min-h-screen">
            <div className="absolute inset-0 bg-[#030014]/50 backdrop-blur-[8px]" />
            <SectionRevealWrapper className="relative z-10 container mx-auto" delay={0.5}>
              <Projects />
            </SectionRevealWrapper>
          </section>
          ...
          <section id="contact" className="relative min-h-screen">
            <div className="absolute inset-0 bg-[#030014]/50 backdrop-blur-[8px]" />
            <SectionRevealWrapper className="relative z-10 container mx-auto" delay={0.6}>
              <Contact />
            </SectionRevealWrapper>
          </section>
