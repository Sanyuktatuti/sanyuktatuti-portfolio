...
export const metadata: Metadata = {
  ...
  description: "Software Engineer & MS CS Student at USC with expertise in full-stack development, algorithms, and machine learning & genAI",
  keywords: ["Software Engineer", "Full Stack Developer", "USC", "Machine Learning", "AI", "React", "Node.js", "Python"],
